...
namespace UnityStandardAssets.CrossPlatformInput
{
    ...
    public class LHJoystick : MonoBehaviour
    {
...

        {
            ...
            //合并Standard Assets中的Joystick===============
            this.OnTouchMove += OnJoystickMove;
        ...
        {
            float moveX = Mathf.Cos(joystickData.radians) * joystickData.power;
            float moveZ = Mathf.Sin(joystickData.radians) * joystickData.power;
            // print(moveX+"/"+moveZ);
            if (m_UseX)
            {
                m_HorizontalVirtualAxis.Update(moveX);
            }

            if (m_UseY)
            {
                m_VerticalVirtualAxis.Update(moveZ);
            }
        }
